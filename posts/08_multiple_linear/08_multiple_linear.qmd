...
::: {.column width="30%"}
![Is baseball boring?](asleep_at_baseball_game.png)
:::
...
::: {.callout-tip}
## Using the Coefficients of Determination
...
* [math](https://mathcenter.oxford.emory.edu/site/math117/explainedVariation/)
* [nomenclature](https://app.coursekata.org/preview/book/31abfbe4-f821-42a5-87bb-2deaa9e958f6/lesson/6/8) by CourseKata
* [thorough discussion](https://statisticsbyjim.com/regression/interpret-r-squared-regression/) by Jim Frost
