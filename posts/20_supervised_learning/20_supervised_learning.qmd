...
LASSO regression, through its penalization, is one of Derek's favorite machine learning techniques.  The process allows an analyst to literally zero out some variables and coefficients and push toward more parsimonious and interpretable models.
:::
...
::: {.callout-note collapse="true"}
## (optional) Principal Components Regression
